...
for (const token of [
  ...
  '__V3_NO_MATCH_9XQ__',
  'real product search returned no visible products',
  'no-result search did not show the empty state',
  'clearing search did not restore the catalog',
...
for (const token of [
  ...
  'body.pb-v3-page:has(#smCheckoutSheet.open) .pb-v3-topbar',
  '.pb-v3-page .sm-checkout-sheet',
