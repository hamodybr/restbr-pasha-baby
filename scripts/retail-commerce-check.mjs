...
requireText('sw.js', 'js/pasha-arabic-only.js?v=1.4', 'cached Arabic-only policy');
requireText('sw.js', 'js/pasha-number-normalizer.js?v=1.2', 'cached English-digit normalizer');

requireText('js/supabase-config.js', 'js/pasha-arabic-only.js?v=1.4', 'Arabic-only policy loader');
