...
if (!sw.includes('js/pasha-product-gallery-thermal-v1.js?v=1.3')) fail('sw.js: thermal product gallery helper v1.3 is not cached');
...
requireText('js/supabase-config.js', "script.src = 'js/pasha-arabic-only.js?v=2.2'", 'Arabic-only bootstrap');
...
requireText('js/pasha-arabic-only.js', 'js/pasha-product-gallery-thermal-v1.js?v=1.3', 'mobile thermal gallery loader v1.3');
