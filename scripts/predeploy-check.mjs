...
if (!sw.includes('js/pasha-product-gallery-thermal-v1.js?v=1.0')) fail('sw.js: thermal product gallery helper is not cached');
...
requireText('js/pasha-arabic-only.js', 'js/pasha-product-gallery-thermal-v1.js?v=1.0', 'mobile thermal gallery loader');
