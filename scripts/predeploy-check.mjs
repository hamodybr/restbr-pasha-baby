...
if (!sw.includes('js/pasha-arabic-only.js?v=1.5')) fail('sw.js: Arabic-only policy is not cached');
...
requireText('js/supabase-config.js', "script.src = 'js/pasha-arabic-only.js?v=1.5'", 'Arabic-only bootstrap');
