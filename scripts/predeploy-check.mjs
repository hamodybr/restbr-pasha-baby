...
if (!sw.includes('js/pasha-arabic-only.js?v=2.1')) fail('sw.js: Arabic-only policy is not cached');
...
requireText('js/supabase-config.js', "script.src = 'js/pasha-arabic-only.js?v=2.1'", 'Arabic-only bootstrap');
