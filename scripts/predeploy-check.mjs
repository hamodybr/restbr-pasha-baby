...
if (!sw.includes('js/pasha-arabic-only.js?v=1.4')) fail('sw.js: Arabic-only policy is not cached');
...
requireText('js/supabase-config.js', "script.src = 'js/pasha-arabic-only.js?v=1.4'", 'Arabic-only bootstrap');
