  ...
  function printOrder(orderId) {
    ...
    popup.document.write(`<!doctype html><html lang="ar" dir="rtl"><head><meta charset="utf-8"><meta name="viewport" content="width=device-width,initial-scale=1"><title>${esc(order.order_number)} — Pasha Baby</title><style>
      ...
      *{box-sizing:border-box}
      html,body{margin:0;padding:0;min-width:0;background:#fff;color:#000;font-family:Tahoma,Arial,"Segoe UI",sans-serif;font-size:14pt;font-weight:600;line-height:1.5;font-variant-numeric:tabular-nums;-webkit-print-color-adjust:exact;print-color-adjust:exact}
      ...
      .orderline{display:flex;justify-content:space-between;align-items:center;gap:5mm;margin-bottom:3mm;border-bottom:1pt solid #000;padding-bottom:2.5mm;break-inside:avoid}.orderline strong{font:900 16pt/1.2 ui-monospace,SFMono-Regular,Consolas,monospace;direction:ltr;text-align:left}.orderline span{font-size:13pt;font-weight:800}
      .customer{border:1.5pt solid #000;border-radius:2mm;padding:3mm;margin-bottom:3.5mm;font-size:14pt;font-weight:700;line-height:1.55;break-inside:avoid}.customer b{font-size:16pt;font-weight:900}.phone{direction:ltr;display:inline-block;font-weight:900}.address{margin-top:1.5mm;font-weight:800}
      .items{border-top:1.5pt solid #000;border-bottom:1.5pt solid #000}.item{display:grid;grid-template-columns:minmax(0,1fr) auto;gap:6mm;align-items:start;padding:2.8mm 1mm;border-bottom:1pt solid #000;font-size:14pt;font-weight:700;line-height:1.5;break-inside:avoid}.item:last-child{border-bottom:0}.item b{font-weight:900}.item strong{white-space:nowrap;font-weight:900;direction:ltr;text-align:left}.option{margin-top:1mm;font-size:12.5pt;color:#000;font-weight:800}.delivery-item,.delivery-item .option{color:#000}
      .notes{margin-top:3.5mm;padding:3mm;border:1.25pt solid #000;border-radius:1.5mm;font-size:13pt;font-weight:700;line-height:1.5;break-inside:avoid}.totals{margin-top:4mm;border:2pt solid #000;border-radius:1.8mm;padding:3mm;display:grid;gap:1.5mm;break-inside:avoid}.row{display:flex;justify-content:space-between;gap:5mm;font-size:14pt;font-weight:800}.row b{white-space:nowrap;direction:ltr}.row.grand{font-size:20pt;font-weight:900;border-top:1.5pt solid #000;padding-top:2.2mm}.footer{text-align:center;margin-top:3mm;font-size:12.5pt;font-weight:900;break-inside:avoid}.screen-actions{display:flex;gap:8px;padding:12px;position:fixed;left:0;right:0;bottom:0;background:#eee;z-index:5}.screen-actions button{flex:1;padding:12px;border:0;border-radius:8px;background:#000;color:#fff;font-size:16px;font-weight:900}
