(() => {
  ...
  function loadArabicAdminTools() {
    ...
    loadScript('pashaOrdersCustomersScript', 'js/admin-orders-customers.js?v=1.9', true);
  ...
  function boot() {
    ...
    loadScript('pashaProductGalleryThermalScript', 'js/pasha-product-gallery-thermal-v1.js?v=1.1');
